		...
		<>
			<MaxWidthWrapper className="mb-12 mt-10 sm:mt-40 flex flex-col items-center justify-center text-center">
				...
				<p className="mt-5 max-w-prose text-zinc-200 sm:text-lg">
					This is a <b>POC</b> solution for the <b>Industrial Power Network</b>{" "}
					Homework for cable sizing and dimensioning using the{" "}
					<b>IEC 60364-5-52</b> standard.
				</p>

				<p className="mt-5 max-w-prose sm:text-xl">
					<span className=" text-blue-400">
						Made by: Abderrahmane Taha Khenchouche
					</span>
				</p>
